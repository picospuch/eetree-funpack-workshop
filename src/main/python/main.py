...
class MainWindow(QMainWindow):
    ...
    def __init__(self, appctxt):
        ...
        self.setWindowTitle("EetreeFunpackRadio")
    ...
    def checkSettings(self):
        ...
        if settings.value('settings_set', type=bool):
    ...
    def handleDevice(self, quiet=False):
        ...
        print('[dbg] set device: ' + newDevice)
        if newDevice is None:
            return False
        print('[dbg] hd ' + str(self.soapy.device))
        try:
