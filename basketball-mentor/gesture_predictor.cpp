...
int PredictGesture(tflite::ErrorReporter* error_reporter, float* output) {
  ...
  TF_LITE_REPORT_ERROR(error_reporter, "p0: %f, p1: %f, p2: %f, p3: %f\n",
                       prediction_history[0][prediction_history_index],
                       prediction_history[1][prediction_history_index],
                       prediction_history[2][prediction_history_index],
                       prediction_history[3][prediction_history_index]
                       );
